...
DATA_PATH = os.path.join(ROOT_DIR, "text_files")  # 'D:/work/research/gan-accounting/data'
AAER_PATH = os.path.join(DATA_PATH, 'aaer')
EX_AAER_PATH = os.path.join(DATA_PATH, 'aaerex')  # aaer corpus plus files located in admin dir
