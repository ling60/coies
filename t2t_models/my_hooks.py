...
class PredictHook(tf.train.LoggingTensorHook):
    ...
    def after_run(self, run_context, run_values):
        ...
        #         f.write('%s\n' % v)
        # raise MemoryError
        t = tf.get_default_graph().get_tensor_by_name('body/model/parallel_0/body/decoder/layer_5/ffn/layer_postprocess/layer_norm/add_1:0')
