...
# conf_dict['context_size'] = 20
# conf_dict['context_threshold'] = 0.7
# conf_dict['word_threshold'] = 0.5
# conf_dict['topn'] = 3
# run_for_epochs(const.EXAMPLE_FILE, file_list, oneshot.OneShotTestContextWVSum, config_dict=conf_dict, epochs=1)
